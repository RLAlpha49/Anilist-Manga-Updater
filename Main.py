...
manga_data_time_taken = manga_data_end_time - manga_data_start_time
...
manga_update_time_taken = manga_update_end_time - manga_update_start_time
print(f"\nTime taken to get Update Manga data: {manga_update_time_taken} seconds")

print(f"\nTotal time taken: {manga_data_time_taken + manga_update_time_taken} seconds")
